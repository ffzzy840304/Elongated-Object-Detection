...
def parse_args():
  ...
  parser.add_argument('--cfg', dest='cfg_file',
                      ...
                      default='/home/user01/faster-rcnn-pytorch/cfgs/res101.yml', type=str)
  parser.add_argument('--net', dest='net',
                      help='vgg16, res50, res101, res152',
                      default='/home/user01/faster-rcnn-pytorch/res101', type=str)
  parser.add_argument('--set', dest='set_cfgs',
                      help='set config keys', default=None,
                      nargs=argparse.REMAINDER)
  parser.add_argument('--load_dir', dest='load_dir',
                      help='directory to load models',
                      default="/home/uer01/faster-rcnn-pytorch/save_models")
  parser.add_argument('--image_dir', dest='image_dir',
                      help='directory to load images for demo',
                      default="/home/user01/faster-rcnn-pytorch/images/")
                     # default='data/VOCdevkit2007/VOC2007/JPEGImages_coco_baseballbat')
  ...
  while (num_images >= 0):
      ...
      for j in xrange(1, len(pascal_classes)):
          ...
          if inds.numel() > 0:
            ...
            im2show = vis_detections(im2show, imglist[num_images], pascal_classes[j], cls_dets.cpu().numpy(), 0.5)
           # im2show = vis_detections(im2show, imglist[num_images], str(j), cls_dets.cpu().numpy(), 0.5)
      misc_toc = time.time()
      ...
      if vis and webcam_num == -1:
          ...
          print(detect_time,nms_time)
          result_path='/home/user01/faster-rcnn-pytorch/detect_results/'+imglist[num_images]
